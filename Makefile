...
#    Updated: 2020/11/14 02:12:44 by dihauet          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(DIROBJ)%.o:	$(DIRSRCS)%.c $(INC)
				@mkdir -p $(DIROBJ)/md5 $(DIROBJ)/sha256 $(DIROBJ)/sha3 $(DIROBJ)/base64
